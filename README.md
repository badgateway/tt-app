...
http://localhost:8531/app/new?nickname=tt-app&url=http://localhost:8902/&clientId=tt-app&allowedGrantTypes=authorization_code,refresh_token&redirectUris=http://localhost:8902/
